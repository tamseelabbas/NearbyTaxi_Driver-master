...
mTaxiNumber=(EditText)findViewById(R.id.taxiNumber);
    ...
    private void attemptLogin() {
        ...
        String taxiNumber=mTaxiNumber.getText().toString();
        ...
        if (cancel) {
            ...
            intent.putExtra("TaxiNumber",taxiNumber);
